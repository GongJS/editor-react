...
const defaultCoverImgUrl = 'http://vue-maker.oss-cn-hangzhou.aliyuncs.com/vue-marker/5f79389d4737571e2e1dc7cb.png';

const PublishForm: React.FC<PublishFormProps> = ({
  isSaving, isPublishing, closePreview, saveWork, previewURL, checkAndpublish,
}) => {
  ...
  useEffect(() => {
    ReactDOM.render(<QRCode value={previewURL} size={120} />, document.getElementById('preview-barcode-container'));
  }, []);
  return (
    <div className="publish-form-container">
      ...
      <Row align="middle" style={{ marginBottom: '20px' }}>
        ...
        <Col span={10}>
          <div className="file-upload-container">
            <StyledUploader onSuccess={updateAvatar} uploadedImgSrc={page.setting.shareImg || defaultCoverImgUrl} />
          </div>
        </Col>
      </Row>
      <Form
      ...
      >
        ...
        >
          <Input value={page.desc} onChange={() => updatePage('desc', form.getFieldValue('desc'))} />
        </Form.Item>
        <Form.Item wrapperCol={{ span: 18, offset: 4 }}>
          <Button type="primary" onClick={checkAndpublish} loading={isPublishing} htmlType="submit">
            发布
          </Button>
